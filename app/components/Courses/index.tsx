            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        <h3 className="text-midnightblue text-4xl lg:text-55xl mb-5 sm:mb-0 balootamma">How We Work?</h3>
                        <Link href={'/'} className="text-Blueviolet text-lg font-medium space-links">About us&nbsp;&gt;&nbsp;</Link>
                    </div>
                            ...
                            <div key={i}>
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-20 shadow-courses rounded-2xl'>
                                    <div className="relative rounded-3xl">
                                        ...
                                        <div className="absolute right-5 -bottom-2 bg-[#2FA8A3] rounded-full p-6">
                                            <h3 className="text-white uppercase text-center text-sm font-medium">The<br /> Most</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div className="px-3">
                                        ...
                                        <div className="flex justify-between pt-6">
                                            <div className="flex gap-4">
                                                ...
                                                <h3 className="text-base font-medium text-black opacity-75">{items.classes} Devices</h3>
                                            </div>
                                            <div className="flex gap-4">
                                                <Image src={'/assets/courses/users.svg'} alt="users" width={24} height={24} className="inline-block m-auto" />
                                                <h3 className="text-base font-medium text-black opacity-75">{items.students} Customers</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
