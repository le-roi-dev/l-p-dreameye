...
const products: ProductType[] = [
    ...
    },
    {
        id: 2,
        section: "Contact",
        link: ['Help/FAQ', 'Doctors', 'Clients', 'Owners', 'Partners']
    }
    ,
    {
        id: 3,
        section: "More",
        link: ['Appointment', 'Expert Doctor', 'Consultation', 'Enjoy Life', 'About']
    }
]
        ...
        <div className="mx-auto max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    <div className="flex flex-shrink-0 items-center border-right text-2xl">
                        {/* <Image src="/assets/logo/logo.svg" alt="logo" width={214} height={66} /> */}
                        Dream Eye
                    </div>
                    <h3 className='text-xs font-medium text-gunmetalgray lh-160 mt-5 mb-4 lg:mb-16'> We are here to help <br /> Please contact us.</h3>
                    <div className='flex gap-4'>

                        {socialLinks.map((items, i) => (
                        <Link href={items.link} key={i}>
                            <div className="bg-white h-12 w-12 shadow-xl text-base rounded-full flex items-center justify-center footer-icons hover:bg-[#1E96A1]">
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-gray-blue'>
                <h4 className='text-dark-red opacity-75 text-sm text-center md:text-start font-normal'>@2023.DreamEye.All rights reserved</h4>
